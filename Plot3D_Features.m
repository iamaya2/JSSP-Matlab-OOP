function []= Plot3D_Features(folder, featureID1,featureID2,featureID3, heurID, objective)
nbJobs = 10;
nbMachines = 10;
timeRanges = [0 100];
...
featID3 = featureIDrepository(featureID3);
...
%                     +"T2"+num2str(timeRanges(2))+"Rep"+num2str(NB)+"featureID_"+featID1+".mat");
                ...
                elseif featureID2 ==5
                 ...
                 if featureID3 == 1
                    FeatMatrix(NB,3) = normalizeFeature(Mirsh175(JSSPInstance{1}),1);
                elseif featureID3 ==2
                    FeatMatrix(NB,3) = normalizeFeature(Mirsh15(JSSPInstance{1}),2);
                elseif featureID3 ==3
                    FeatMatrix(NB,3) = normalizeFeature(Mirsh29(JSSPInstance{1}),3);
                elseif featureID3 ==4
                    FeatMatrix(NB,3) = normalizeFeature(Mirsh282(JSSPInstance{1}),4);   
                elseif featureID3 ==5
                    FeatMatrix(NB,3) =normalizeFeature(Mirsh95(JSSPInstance{1}),5); 
                end
                FeatMatrix(NB,4)= -JSSPInstance{2};
  end
...
%   
  ...
  scatter3(x,y,z,s,symbol,"filled",'MarkerEdgeColor',[0 0 0],'MarkerFaceColor',color,'MarkerFaceAlpha', 0.5)
