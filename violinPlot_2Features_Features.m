folder=["ConfirmatoryStage/PruebasFeatures/NormalizedFeatures/Feature_Mirsh29/0" "ConfirmatoryStage/PruebasFeatures/NormalizedFeatures/Feature_Mirsh29/0.25" "ConfirmatoryStage/PruebasFeatures/NormalizedFeatures/Feature_Mirsh29/0.5" "ConfirmatoryStage/PruebasFeatures/NormalizedFeatures/Feature_Mirsh29/0.75" "ConfirmatoryStage/PruebasFeatures/NormalizedFeatures/Feature_Mirsh29/1"];
featureID1=3;
featureID2=4;
...
for t=1:length(target)
  ...
  for NB=1:nbInstances;
                  ...
                  PathAddress = char(folder2+"\"+folder(t)+"\");
...
%    figure
CATEGORYNAMES = {"0" "0.25" "0.5" "0.75" "1"};
    violinplot(ViolinMatrix, CATEGORYNAMES,'ViolinColor',[1 0 0],'width', 0.3, 'violinalpha', 0.9, 'ShowData', false) 
    xlabel("Mirsh29 (normalized)")
    ylabel("Mirsh282 (normalized)")
