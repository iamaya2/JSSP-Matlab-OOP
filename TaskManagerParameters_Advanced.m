...
nbRep = 1; %Number of instances per combination
...
objective = 2;
delta = -45; % optional; needs to be added to the parameters
toPlot = false; %optional; needs to be added to the parameters
TaskManagerPrueba_Advanced(nbJobsV,nbMachinesV,timeRanges,population,selfconf, globalconf, unifyfactor, nbRep, heurID, objective, delta);